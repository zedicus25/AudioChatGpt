...
const RegistrationModal = (props) => {
    ...
    const signUp = async (e) => {
        ...
        if (Object.keys(formErrors).length === 0) {
            const res = await api.signUp(formValues.username, formValues.password);
            if (res == undefined) {
                setVisibility(true);
                return;
            }
    ...
    return (
        <Modal
            ...
            centered>
            <Modal.Body style={{backgroundColor:"#93B7BE"}}>
                    ...
                    <form className="Auth-form">
                        ...
                        <div className="Auth-form-content">
                            ...
                            <div className="d-grid gap-2 mt-3">
                                <button type="button" onClick={(e) => signUp(e)} className="btn my-btn">
                                    Sign Up
                                </button>
                            </div>
                            <div className="d-grid gap-2 mt-3">
